...
function MainMultan(){
    const [data, setData] = useState(MultanData);
     ...
     <Container fluid className='container7'>
                <Row>
                    ...
                    <div className='search'>
                        ...
                        <Row className="aa">
                            <Col>
                                <h6>Distance from centre of Multan</h6>
                                <div className="check">
            ...
            <Col xl={7}>
        <Row className="h3">
        <h3>Multan: 341 properties found</h3>
        </Row>
           {data.map((val) => {
       return(
