...
import "../Components/Karachi.css";
import { useState } from "react";
import KarachiData from "./KarachiData";
...
function MainKarachi(){
    const [data, setData] = useState(KarachiData);
     ...
     <Container fluid className='container7'>
                <Row>
                    ...
                    <div className='search'>
                        ...
                        <Row className="aa">
                            <Col>
                                <h6>Distance from centre of Karachi</h6>
                                <div className="check">
            ...
            <Col xl={7}>
        <Row className="h3">
        <h3>Karachi: 341 properties found</h3>
        </Row>
           {data.map((val) => {
       return(
