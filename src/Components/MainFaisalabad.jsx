...
import Faisalabad from "./Faisalabad";
import "../Components/Faisalabad.css";
import { useState } from "react";
import FaisalabadData from "./FaisalabadData";
...
function MainFaisalabad(){
    const [data, setData] = useState(FaisalabadData);
     ...
     <Container fluid className='container7'>
                <Row>
                    ...
                    <div className='search'>
                        ...
                        <Row className="aa">
                            <Col>
                                <h6>Distance from centre of Faisalamad</h6>
                                <div className="check">
            ...
            <Col xl={7}>
        <Row className="h3">
        <h3>Faisalabad: 341 properties found</h3>
        </Row>
           {data.map((val) => {
       return(
