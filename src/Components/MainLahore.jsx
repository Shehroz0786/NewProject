...
function MainLahore(){
    const [data, setData] = useState(LahoreData);
     ...
     <Container fluid className='container7'>
                <Row>
                    ...
                    <div className='search'>
                        ...
                        <Row className="aa">
                            <Col>
                                <h6>Distance from centre of Lahore</h6>
                                <div className="check">
                        ...
                        <Row className="aa">
                            <Col >
                                <h6>Neighbourhood</h6>
                                <div className="check">
                                    <input type='checkbox' name='Gulberg'></input>
                                    <label for='Gulberg'>Gulberg</label><br />
                                    <input type='checkbox' name='M.M. Allam Road'></input>
                                    <label for='M.M. Allam Road'>M.M. Allam Road</label><br />
                                    <input type='checkbox' name='Johar Town'></input>
                                    <label for='Johar Town'>Johar Town</label><br />
                                    <input type='checkbox' name='Township'></input>
                                    <label for='Township'>Township</label><br />
                                    <input type='checkbox' name='Mall Road'></input>
                                    <label for='Mall Road'>Mall Road</label><br />
                                </div>
                            </Col>
                        </Row>
                        </Col>
            ...
            <Col xl={7}>
        <Row className="h3">
        <h3>Lahore: 341 properties found</h3>
        </Row>
           {data.map((val) => {
       return(
